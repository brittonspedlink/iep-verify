...
const fieldDefinitions: FieldDefinition[] = [
  ...
  {
    key: "accommodations",
    label: "Generated Accommodations",
    placeholder: "Paste the accommodations generated by SpedLink. These will be reviewed for evidence support, need alignment, completeness, and unsupported recommendations.",
    kind: "textarea",
  },
  {
    key: "services",
    label: "Generated Services Recommendations",
    placeholder: "Paste the services recommendations generated by SpedLink. These will be reviewed for evidence support and alignment to documented student needs and goals.",
    kind: "textarea",
  },
  {
    key: "recommendedTEKS",
...
const groups: Array<{
  ...
  {
    title: "SpedLink Generated Documents",
    description:
      "Paste SpedLink-generated documentation here and verify each section against the supplied evidence.",
